...
DEFAULT_THREADS = env("THREADS", default=waitress.adjustments.Adjustments.threads)
...
class Command(BaseCommand):
    ...
    Args:
        --threads: The number of threads (Defaults to number of cores)
        listen_address: The listen address and port (Defaults to 127.0.0.1:8000)
    """
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("listen_address", nargs="?", default=DEFAULT_LISTEN_ADDRESS, help=f"Listen address (default: {DEFAULT_LISTEN_ADDRESS}")
